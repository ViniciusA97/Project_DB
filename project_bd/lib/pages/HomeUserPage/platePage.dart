              ...
              children: <Widget>[
                ...
                Material(
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () async{
                      cart = Cart(_prato, quant);
                      print(cart.prato.name);
                      print("CARALHO\n\n\n\n\n\n\n");
                      print(await control.saveCart(cart));
                      print("Dados no bd\n\n\n\n\n\n\n");
                      print(await control.getCart());
                      Navigator.push(context, MaterialPageRoute(builder: (context) => CartPage())); /*print('AAAA');
                      List<Prato> tmp = new List();
                      bag.add(this._prato);                      
                      List<int> qts = new List();
                      qts.add(this.quant);
                      print("Sacola ta: $bag");
                      final result = await Navigator.push(context, MaterialPageRoute(builder: (context) => BagPage(bag, qts)));
                      setState(() {
                        this.bag = result;
                        print("Alterou");
