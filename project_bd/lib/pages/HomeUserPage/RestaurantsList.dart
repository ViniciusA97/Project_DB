...
class RestaurantsList extends StatefulWidget{
  ...
  @override
  State<StatefulWidget> createState()=> _RestaurantsListState(this._restaurants);
          ...
          itemBuilder: (BuildContext context, int index) {
            return Container(
              ...
              child: Column(
                ...
                Text('${this._restaurants[index].name}'.substring(0,1).toUpperCase()+'${this._restaurants[index].name}'.substring(1).toLowerCase(), style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),),
                
                //Lembrar de trocar a próxima linha pela de baixo assim que tratar o erro no banco.
                Text('Av. Pres. Epitácio Pessoa', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Color.fromRGBO(190,190,190,1),),),
