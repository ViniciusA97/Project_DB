...
class Control {
  ...
  Future<List<Pedido>> getRelatorio30day(int idRest) async {
    return await this._db.getRelatiorio2_30days(idRest);
  }
  ...
  Future<void> deletePlate(int idPlate) async {
    this._db.deletePlate(idPlate);
  }

  Future<void> changePlateName(int id, String name) async {
    this._db.changeNamePlate(id, name);
  }

  Future<void> changePlateDescription(int id, String desc) async {
    this._db.changeDescPlate(id, desc);
  }

  Future<void> changePlateImage(int id, String img) async {
    this._db.changeImgPlate(id, img);
  }
  ...
  Future<bool> savePedido(String adress) async {
    ...
    Pedido p = new Pedido(this._pratos, this.user, this._qnt, adress);
    double value = 0;
